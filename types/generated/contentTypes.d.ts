...
export interface ApiProjetKstProjetKst extends Struct.CollectionTypeSchema {
  collectionName: 'projet_ksts';
  info: {
    displayName: 'Projet KST';
    pluralName: 'projet-ksts';
    singularName: 'projet-kst';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CurrentAmount: Schema.Attribute.BigInteger;
    Description: Schema.Attribute.Blocks;
    GoalAmount: Schema.Attribute.BigInteger;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::projet-kst.projet-kst'
    > &
      Schema.Attribute.Private;
    Order: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSoutienSoutien extends Struct.CollectionTypeSchema {
  collectionName: 'soutiens';
  info: {
    displayName: 'Soutien';
    pluralName: 'soutiens';
    singularName: 'soutien';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::projet-kst.projet-kst': ApiProjetKstProjetKst;
      'api::soutien.soutien': ApiSoutienSoutien;
